...
# Display Table
knitr::kable(log_claims_comparison,
             col.names = c("Income Category", "Median Log Claims", "SD Log Claims"),
             digits = 2)
...
affluent_data <- merged_analysis %>% filter(income_category == "affluent")
high_poverty_data <- merged_analysis %>% filter(income_category == "high_poverty")
